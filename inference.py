...
parser.add_argument('--save_dir', type=str, help='saving directory',
        default="./Waymo_Dataset/inference/")
parser.add_argument('--file_dir', type=str, help='Test Dataset directory',
        default="./Waymo_Dataset/preprocessed_data/test/")
...
parser.add_argument('--test', action='store_true', help="Inferring on test data")
parser.add_argument('--val', action='store_true', help="Inferring on validation data")
